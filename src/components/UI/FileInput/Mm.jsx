...
let counter = 0;
const Mm = ({ className, files, setFiles, fileError, maxFiles = 10, clear = true }) => {
  ...
  return (
    <>
      <div style={photoStyle} className={className ? [cl.FileInput, className].join(" ") : cl.FileInput}>
        ...
        {/* File input area */}
        {files.length === 0 && (
          <div className={cl.noPhotosContainer}>
            <input
              ref={fileInputRef}
              type="file"
              multiple
            ...
            />
            <div className={cl.uploadText}>Добавить фото</div>
          </div>
        )}

        {/* Add more files button */}
        {/* {files.length > 0 && files.length < maxFiles && (
          <div className={cl.addMoreContainer}>
            <input
              ref={fileInputRef}
              type="file"
              multiple
              ...
              className={cl.fileInput}
            />
            <div className={cl.addMoreButton}>+</div>
          </div>
        )} */}
